...
*Sacha:* I initially reached out to you because I read your blog post about foreign function interfaces and all those other things, and then I
realized you are the same guy who put together skewer-mode and other
really, really cool interactive ways to use Emacs.  But before we dig into how you got into Emacs and all the interesting
...
for nine years.  I run regularly, I'm out there three days a week.  I like computer games.  I like reading.  I spend a lot time watching YouTube videos actually, that's a big hobby.  I find these long, half-an-hour-long clips, mostly people playing video games.  So instead of playing games myself I watch people play games.  A lot of the time I can do my own thing while doing that, so it's almost like multitasking that way.
...
week.  I like the constraints, but I only need to worry about it for about a week, and then I get to forget about it after that.

*Sacha:* You mentioned you started Emacs just nine years ago, which is pretty amazing.  How did you get into it?

*Christopher:* I was on an internship in college at the time, and I was getting a lot more serious about programming.  I've been programming for nineteen years now, ever since I was a little kid.  When doing the internship I was getting serious about it, and up until that points I'd just been using KWrite and some other, some basic stuff.

I read something, probably by Richard Stallman, and some Steve
...
lot of it did.  For example, this thing will tell me how many words are in a buffer, and I dropped that into my configuration.
...
things up in a nice clean blocks.  That happened at about the same time I got source control, almost like a rewrite.

*Sacha:* Now nine years ago we didn't have a lot of the same resources we have now about for learning more about Emacs configuration, no Github
...  I don't remember if EmacsWiki was around then.  So you mentioned
the book was useful, the O'Reilly book, where there other resources you
found helpful?
...
You mentioned coworkers.  Do you have other coworkers who are actually
using Emacs too?
...
with Emacs internals to just say, "Oh, I think I would like Emacs to interact live with a web browser?"
...
To elaborate on that, I've got a Steam account, I've got
...
*Sacha:* Emacs is more addictive than the games you can play on Steam.
...
digging around in the code and figuring out how to do it.
...
But would you like to take us through some of the highlights of your config.  Particularly interesting snippets that you like using.
...
point.  It sort of groups related configuration options together into
...
I don't have to list any of the packages explicitly.  So
...
Then there's asterisks on other things that has to do
...
So there's =impatient-mode= and Skewer.  So FFI, foreign
...
and it can push all these values onto the stack, and pop the values
...
I'm going to make a SQLite database.  So we've got this connection object.

This is using a really cool part of Emacs, it came from CEDET, called EIEIO, which I think is really clever.
...
I build up these vectors of symbols and this actually compiles into SQL
expressions.  If I can demonstrate that.
...
I created it after Google Reader shut down.  I wasn't happy with any of
...
*Sacha:* So it sounds like you spend fair bit of your life inside Emacs.
You read blogs, web browsers, and other things...  what else do you do
inside Emacs?

*Christopher:* I do email too.  I prefer Notmuch as my email client.

http://notmuchmail.org/

*Sacha:* I heard good things about it.  What do you like about it?

*Christopher:* If you notice, it looks pretty similar to Elfeed.  You see tags on the right.  It actually inspired the interface for Elfeed.

I like how fast the searching is, how quickly everything is.

*Sacha:* I'm going to give it a try.  I've been using GNUS for handling mail, but Notmuch does look very interesting.
...
use it just as a calculator or do you have any other fancy things with
it?
...
*Sacha:* That's great.  I still have to get the hang of all these things.  Calc is great, it's like a microcosm of Emacs.  This absurdly powerful and flexible thing.
...
*Christopher:* Oh yeah.  I write my blog in Markdown.  All those posts are Markdown.  All the READMEs.  I just prefer Markdown for all my
documentation.

I haven't made the jump to org-mode yet.  I've never learned enough
about it to make good use of it.  I know you love org mode right?

*Sacha:* I find it to be similarly flexible.  You can do all sorts of
crazy things with it.  But you've got lots of things in Markdown, basically that's the way your brain works.  I guess org mode is similar, but the syntax is different.  There's a little bit of friction to get over.
